...
public class Main {
    ...
    private static void playGame(Game game, BufferedReader reader, BufferedReader inFromOpponent, DataOutputStream outToOpponent, boolean key, int hits) throws IOException {
        String sentence;
    ...
    private static void setupShips(Game game, BufferedReader reader) throws IOException {
        String sentence;
    ...
    private static ServerSocket setupServer(BufferedReader reader) throws IOException {
        ServerSocket serverSocket;
        String ip;
        int port;
